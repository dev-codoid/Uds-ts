...
import { putcreatepasswordDetails } from "../../ReactQuery/reactQuery";
...
const PasswordCompo = () => {
    const { setIsNewUser, isNewUser, setOwnerDetails, setIsLoading, setSelectedLocationData, setOwnerinnerDetails, ForgotEmailId } = useStore(
        (state) => state
    );
    ...
    console.log(Password, "Password", ForgotEmailId.email);


    const onFormSubmit = () => {
        if (userData.password !== "" && userData.password1 !== "" && userData.password == userData.password1) {
            ...
            if (isValidPassword == true && isValidPassword1 == true) {
                ...
                toast.info("*Password must be at least 8 characters long and include an uppercase letter, lowercase letter, digit, and special character.")
            }
                        ...
                        <form onClick={(e) => e.preventDefault()}>
                            <div>
                                ...
                                {error && userData.password1 == "" ? (
                                    <p className={styles.errorContainer}>Valid New Password Required</p>
                                ) : (
                                    <p></p>
                                )}                            </div>
                            <div>
                                ...
                                {error && userData.password == "" ? (
                                    <p className={styles.errorContainer}>Valid Confirm Password Required</p>
                                ) : (
                                    <p></p>
                                )}
                            </div>
