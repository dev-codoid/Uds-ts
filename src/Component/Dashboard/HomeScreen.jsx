  ...
  const TicketPayloadsPass = {
    ...
    status:
      activeButton == "All"
        ...
        : activeButton == "Open"
        ? "0"
        : activeButton == "Inprocess"
        ? "1"
        : activeButton == "Completed"
        ? "2"
        : activeButton == "Close"
        ? "3"
        : activeButton == "Reopen" && "4",
  };
            ...
            <>
              <div className="row  ticketingdashboardcreates">
                <div className="row mt-1 ticket-dashboard_newcreate">
                  <div className="WelcomeCards">
                    <div className="Welcomecontents mt-4">
                      ...
                      <span>
                        ...
                        <br />
                        ensure a swift and satisfactory resolution?"
                      </span>
                      <button
                        onClick={() => {
                          HandleTicketraise();
                  ...
                  <div className="TicketCreateimg"></div>
                </div>
                                    ...
                                    <div className="InnerPhoneContact">
                                      <div>
                                        ...
                                        <p className="text-muted mb-0">
                                          {capitalizeEachWord(
                                            item?.user_role?.role.toLowerCase()
                                          )}
                                        </p>
                                      </div>
                                      ...
                                      <div
                                        className="Phoneimg"
                                        data-tooltip-id="my-tooltip"
                                        data-tooltip-content={item.phone_number}
                                      >
                                        <img src={PhoneCall} />
                                      </div>
                                    </div>
            ...
            <div className="row mt-3 ticket-dashboard">
              ...
              <div className="row Ticketdetails">
                <div className=" Innerticket-dashboard text-center">
                  ...
                  <div
                    className={`col-md-4 CardDesigns mb-3 ${
                      ActiveBars === "Open" ? "active-card" : ""
                    }`}
                  ...
                  <div
                    className={`col-md-4 CardDesigns mb-3 ${
                      ActiveBars === "Inprocess" ? "active-card" : ""
                    }`}
                  ...
                  <div
                    className={`col-md-4 mb-3 ${
                      ActiveBars === "Completed" ? "active-card" : ""
                    }`}
                  ...
                  >
                    <div className="card p-3">
                      ...
                      <h5>Reopened Tickets</h5>
                    </div>
                  </div>

                  <div
                    className={`col-md-4 mb-3 ${
                      ActiveBars === "Close" ? "active-card" : ""
                    }`}
                    onClick={() => handleButtonClick("Close")}
                  >
                    <div className="card p-3">
                      <div className="InnercardImgData">
                        <span className="fiveCard">
                ...
                <div className="col RecentcardTickets mb-3">
                  <div className="card ">
                    <div className="TickerSTatementHeaders">
                      ...
                      <button onClick={() => MoveTotheNextTab()}>
                        View all
                      </button>
                    </div>
                      ...
                      {TicketDatas.length != 0 ? (
                        <>
                          {TicketDatas != undefined &&
                            TicketDatas.map((item, index) => {
                              return (
                                <>
                                  <div
                                    className="containsticketprocess mt-3"
                                    key={index}
                                    onClick={() => {
                                      ticketOverViewFunc(item);
                                    }}
                                  >
                                    <span
                                      className="priority-label inprocess"
                                      style={{
                                        background:
                                          item.status == 0
                                            ? "hsla(15, 88%, 59%, 1)" // Open - light background
                                            : item.status == 1
                                            ? "hsla(32, 92%, 59%, 1)" // In Progress - yellow background
                                            : item.status == 2
                                            ? "hsla(170, 75%, 41%, 1)" // Completed - light green background
                                            : item.status == 3
                                            ? "hsla(140, 82%, 39%, 1)" // Close - light green background for Close
                                    ...
                                    <div className="ticket-item mb-2">
                                      <div>
                                        ...
                                        <img
                                          src={
                                            item.priority == 0
                                              ? ticketresolvedticker
                                              : item.priority == 1
                                              ? ticketreviewsticker
                                              : item.priority == 2
                                              ? ticketinprogressticker
                                              : ticketinprogressticker
                                            ...
                                            {item.clientsub_category_id
                                              ...
                                              item.clientsub_category_id.name
                                                ...
                                                <>
                                                  <span
                                                    data-tooltip-id="my-tooltip"
                                                    data-tooltip-content={capitalizeEachWord(
                                                      item.clientsub_category_id.name.toLowerCase()
                                                    )} // Tooltip content
                                                  >
                                                    {/* {truncateText(
                                                      capitalizeEachWord(
                          ...
                          <>
                            <div className="card ">
                              ...
                              <div className="d-flex Statement Ticket_Statement  align-items-center   mt-2">
                                <div
                                  className="d-flex Recentticketdetils   align-items-center"
                                ...
                                >
                                  ...
                                  <div className="TicketingCardSecuritys">
                                    ...
                                    <div className="TicketStatusoperations">
                                      <button
                                        className="btn track-btn priority-label inprocess "
                                        onClick={() => {
                                          ticketOverViewFunc(item);
                                        }}
                                        style={{
