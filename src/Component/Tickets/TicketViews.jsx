...
const TicketViews = () => {
  ...
  const feedbackOptions = [
    {
      id: "bad",
      label: "Bad",
      imgSrc: activeFeedback == "bad" ? badactiveimg : badimg,
    },
    {
      id: "acceptable",
      label: "Acceptable",
      imgSrc:
        activeFeedback == "acceptable" ? Acceptanceactiveimg : Acceptanceimg,
    },
    {
      id: "good",
      label: "Good",
      imgSrc: activeFeedback == "good" ? goodactiveimg : goodimg,
    },
    {
      id: "excellent",
      label: "Excellent",
      imgSrc: activeFeedback == "excellent" ? excellentimg : excellentactiveimg,
    },
  ];
  ...
  const { data: ticketretrieveRefeshing, refetch: ticketreteievRefetchcalls } =
    useQuery({
  ...
  const { data: remarksretrieve, refetch: gettheremarksdataretrieve } =
    useQuery({
  ...
  const overdueFunctions = (ticketretrieve) => {
    ...
    return `${
      differenceInMinutes > 0 || isNaN(differenceInMinutes)
        ? "Overdue"
        : `Minutes left ${differenceInMinutes * -1}`
    }`;
  };
                      ...
                      <div className="row align-items-center TicketDetailsRecorded">
                        ...
                        <div className="col-md-10 Ticketingrecords">
                          <p className="mb-1 heaerspara">
                            <p className="ticketheader Headerticket">
                              Ticket Number
                            </p>{" "}
                            {ticketretrieve?.ticket_number} <br />
                          </p>
                          ...
                          <p className="mb-1 heaerspara">
                            ...
                            {ticketretrieve?.created_at
                              ? formatDate(ticketretrieve?.created_at)
                              : "--"}{" "}
                            <br />
                          </p>
                          <p className="mb-1 heaerspara">
                            ...
                            {ticketretrieve?.client_closing_at
                              ? formatDate(ticketretrieve?.client_closing_at)
                              : "--"}
                          </p>
                          ...
                          <div className="d-flex justify-content-between">
                            <span>
                              ...
                              <span
                                style={{
                                  color:
                                    ticketretrieve.priority == 0
                                      ? "green"
                                      : ticketretrieve.priority == 1
                                      ? "#e4e42e"
                                      : ticketretrieve.priority == 2 && "red",
                                }}
                              >
                                {ticketretrieve.priority == 0
                                  ? "Low"
                                  : ticketretrieve.priority == 1
                                  ? "Medium"
                                  : ticketretrieve.priority == 2 && "High"}
                              </span>
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="Innerscrollabledesigns">
                      <div className="InnerRecentTicketIndetails">
                        <div class="accordion" id="accordionExample">
                          <div class="card  ">
                            <div
                              class="card-header HeaderCardsticketdetails"
                              id="headingOne"
                                          ...
                                          ticketretrieve?.l1_users?.map(
                                            (item) => {
                                              return (
                                                ...
                                                <>
                                                  {capitalizeEachWord(
                                                    ticketretrieve?.l1_users[0].first_name.toLowerCase() +
                                                      " "
                                                  )}
                                                  {capitalizeEachWord(
                                                    ticketretrieve?.l1_users[0].last_name.toLowerCase()
                                                  )}
                                                </>
                                              );
                                            }
                          ...
                          >
                            ...
                            <div className="card shadow-sm p-2 phonecallcard">
                              ...
                              <div className="timeline-containers">
                                {TIckettimelinerecordDetails &&
                                  Object.keys(TIckettimelinerecordDetails).map(
                                    (key, index) => {
                                      const item =
                                        TIckettimelinerecordDetails[key]; // Get the status object (e.g., open, inprogress, etc.)
                                      const getStatusText = (
                                        statusObj,
                                        statusKey
                                      ) => {
                        ...
                        <div className="card RemarksCards shadow-sm p-3 mb-3">
                          <h6>
                            <span className="ticketheader RemarksHeaders">
                              Remarks{" "}
                            </span>
                          </h6>
                                    ...
                                    <>
                                      ...
                                      >
                                        <p className="Commentslist">
                                          ...
                                          <span>
                                            {formatDatefeed(item.created_at)}
                                          </span>{" "}
                                        </p>
...
: null } */}
                        ...
                        ticketretrieve?.status == 3 ? (
                          <div className="card Satisfactioncard shadow-sm p-3 mb-3">
                            ...
                            <p className="mb-1 cardpara heaerspara">
                              Your feedback brings us great satisfaction and
                              inspires us to improve further!
                            </p>
                              ...
                              {feedbackOptions.map((option) => (
                                <div
                                  ...
                                  className={`feedback-option ${
                                    activeFeedback === option.id
                                      ? "active"
                                      : FeedbackDatas != undefined &&
                                        FeedbackDatas?.id
                                      ? "disabledthefiled "
                                      : ""
                                  }`}
                      ...
                      {ticketretrieve?.status != 3 ? (
                        <>
                          ...
                          ticketretrieve?.status == 3 ? (
                            <div
                              className="col-6   Createticketsviewed"
                              style={{ marginTop: "41px !important" }}
                            >
                              <button
              ...
              <div className="FormParts">
                <div className="innerformscomentpart">
                  ...
                  <div className="feedbacksubmition">
                    ...
                    >
                      {CommentPart.status == 2 ? "Close Ticket" : "Reopen"}
                    </button>
                  </div>
                </div>
              </div>
